...
engine.setProperty("voice",voices[1].id)#sert à changer la voix"1" pour la voix d'homme et "0" pour la voix féminine (cette configuration change d'un pc à un autre)#
